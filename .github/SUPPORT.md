# Getting help with sonatools

Thanks for using sonatools. Before filing an issue, there are a few places
...
Before opening a new issue, be sure to [search issues and pull requests](https://github.com/tidyverse/sonatools/issues) to make sure the 
